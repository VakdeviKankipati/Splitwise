...
public class TestSettleUpController {
    ...
    public void testSettleGroup_Success() {
        ...
        e1_1.setUser(user1);
        e1_1.setAmount(1000);
        e1_1.setExpenseUserType(ExpenseUserType.PAID);
        ...
        e1_2.setUser(user2);
        e1_2.setAmount(300);
        e1_2.setExpenseUserType(ExpenseUserType.OWED);
        ...
        e1_3.setUser(user3);
        e1_3.setAmount(300);
        e1_3.setExpenseUserType(ExpenseUserType.OWED);
        ...
        e1_4.setUser(user1);
        e1_4.setAmount(400);
        e1_4.setExpenseUserType(ExpenseUserType.OWED);
        ...
        e2_1.setUser(user1);
        e2_1.setAmount(2000);
        e2_1.setExpenseUserType(ExpenseUserType.PAID);
        ...
        e2_2.setUser(user2);
        e2_2.setAmount(500);
        e2_2.setExpenseUserType(ExpenseUserType.OWED);
        ...
        e2_3.setUser(user3);
        e2_3.setAmount(1500);
        e2_3.setExpenseUserType(ExpenseUserType.OWED);
        ...
        SettleUpGroupRequestDto settleGroupRequestDto = new SettleUpGroupRequestDto();
        settleGroupRequestDto.setGroupId(group.getId());
        SettleUpGroupResponseDto responseDto = settleUpController.settleGroup(settleGroupRequestDto);
    ...
    public void testSettleUser_Success() {
        ...
        settleUpUserRequestDto.setUserId(user1.getId());
        SettleUpGroupResponseDto responseDto = settleUpController.settleUser(settleUpUserRequestDto);
        assertNotNull(responseDto, "Response dto should not be null");
        assertNotNull(responseDto.getTransactions(), "Transactions should not be null");
        assertEquals(2, responseDto.getTransactions().size(), "There should be 2 transactions");
    ...
    public void testSettleUser_UserNotFound() {
        SettleUpUserRequestDto settleUpUserRequestDto = new SettleUpUserRequestDto();
        settleUpUserRequestDto.setUserId(1);
        SettleUpGroupResponseDto responseDto = settleUpController.settleUser(settleUpUserRequestDto);
